class ResponsesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @response.save
        format.html { redirect_to responses_path, notice: "Response was successfully created.", status: :see_other }
  ...
  private
    ...
    def response_params
      params.fetch(:response, {}).permit(:text, :score, :ip_address, :user_agent, :active)
    end
end
